...
import com.example.baldurstore2.adapter.MobileAdapter;
...
public class LaptopActivity extends AppCompatActivity {
    ...
    private void loadMore() {
        handler.post(new Runnable() {
            ...
            public void run() {
                ...
                mobileAdapter.notifyItemInserted(sanPhamMoiList.size()-1);
            }
        });
        handler.postDelayed(new Runnable() {
            ...
            public void run() {
                ...
                mobileAdapter.notifyItemRemoved(sanPhamMoiList.size());
                page = page + 1;
                getData(page);
    ...
    private void getData(int page) {
        compositeDisposable.add(apiBanHang.getSanPham(page, type)
                        ...
                        sanPhamMoiModel -> {
                            if (sanPhamMoiModel.isSuccess()){
                                if (mobileAdapter == null){
                                    ...
                                    mobileAdapter = new MobileAdapter(getApplicationContext(), sanPhamMoiList);
                                    ...
                                    mobileAdapter.notifyItemRangeInserted(vitri, soluongadd);
                                }
                            } else {
    ...
    private void AnhXa() {
        ...
        recyclerView = (RecyclerView) findViewById(R.id.recycleView_Laptop);
